...
Semantic html tags better describe the meaning of the content they are assigned to. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display:block means the element will occupy 100% width and will start from a new line.

display:inline-block means the element will be inline and will stretch to occupy width of it's own content only.
...
It records changes to files over time and helps keep it organized. 
